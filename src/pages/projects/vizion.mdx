...
export const meta = {
  ...
  date: '2022-10-10',
  title: 'Vizion',
  logo: 'https://cdn.puthraya.com/assets/images/projects/vizion/icon.png',
  link: {
...
<div className="sm:flex items-center mx-auto w-full justify-items-center">
  <div className="justify-self-center text-center w-full">
    <a className="w-full mx-auto no-underline app-store-badge" href="https://apps.apple.com/us/app/vizion-text-snipper/id1637685810" target="_blank" style={{background: 'none',  border: 'none', display: 'inline-block', overflow: 'hidden', borderRadius: '13px', width: '250px', height: '83px'}}>
        <img src="https://cdn.puthraya.com/assets/images/download-on-mac-app-store-badge.svg" alt="Download on the Mac App Store" style={{borderRadius: '13px', width: '250px', height: '83px'}}/>
    </a>
  </div>
...
<figure>
    <img class="" src="https://cdn.puthraya.com/assets/images/projects/vizion/text.gif" alt={''}/>
...
<figure>
  <img class="mx-auto mt-4" src="https://cdn.puthraya.com/assets/images/projects/vizion/Image-of-menu.png"/>
  <figcaption>Vizion always stays in the menu bar. Easily accessible whenever you need it.</figcaption>
</figure>
<figure>
  <img class="mt-4" src="https://cdn.puthraya.com/assets/images/projects/vizion/qr-code.gif"/>
